...
tab1 <- tabPanel("Find Your Hospital",
                 ...
                 tags$div(
                 leafletOutput("intermap",width="100%", height= "800px"),
                ...
                absolutePanel(id = "Pop_Panel", class = "City_Carrier_panel panel panel-default",draggable=TRUE,left="auto",bottom="auto",width = 300,height="auto",
